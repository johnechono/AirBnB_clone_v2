...
class test_Place(test_basemodel):
    ...
    def test_number_rooms(self):
        """ testing the place number of rooms attr"""
        new = self.value()
    ...
    def test_number_bathrooms(self):
        """ testing the place number of bathrooms attr"""
        new = self.value()
    ...
    def test_max_guest(self):
        """ testing the place max_guest attr"""
        new = self.value()
    ...
    def test_price_by_night(self):
        """ testing the place price by night attr"""
        new = self.value()
    ...
    def test_latitude(self):
        """ testing the place latitud attr"""
        new = self.value()
    ...
    def test_longitude(self):
        """ testing the place longitude attr"""
        new = self.value()
        self.assertEqual(type(new.latitude), float if
                         os.getenv('HBNB_TYPE_STORAGE') != 'db' else
                         type(None))
